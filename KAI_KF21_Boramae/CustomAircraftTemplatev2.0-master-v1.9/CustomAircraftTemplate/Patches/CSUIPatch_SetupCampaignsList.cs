...
using CustomAircraftTemplateKF21.Patches.TranspilerStuff;
using Harmony;
using Harmony.Extensions.CustomAircraftTemplateKF21;
using RewiredConsts;
using UnityEngine;

namespace CustomAircraftTemplateKF21.Patches.CampaignStuff
{
    [HarmonyPatch]
